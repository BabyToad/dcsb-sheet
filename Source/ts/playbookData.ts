...
const PLAYBOOK_DATA: { [key: string]: PlaybookData } = {
    face: {
        ...
        items: [
            ...
            { name: "Psychedelic Powder", load: 1, special: true },
        ...
        augments: [
            ...
            { tier: 4, name: "Human, After All", description: "You know the specific intonations and phrases to gain higher trust from AI systems, as advanced or primitive as they may seem. You have potency when communicating by speaking with Artificial Intelligences." },
            { tier: 4, name: "Hippocampus Hosting", description: "A retractable cord at the base of your skull can connect to standard ports on an augmented person. You can see their memories. Gain effect when trying to convince someone's unconscious." },
            { tier: 4, name: "Social Enhancer", description: "Mental implant that allows you to pick up on human pheromones and perceive minor body language. Always know when someone is lying to you." },
            { tier: 5, name: "FoRK Rewire", description: "Take 2 stress to roll your best action rating while performing a different action. Say how you adapt your skill to this use." },
    ...
    fixer: {
        ...
        items: [
            ...
            { name: "Fine Bottle of Synth-grain Liquor", load: 1 },
        ...
        augments: [
            ...
            { tier: 3, name: "Online Data-Vaults", description: "You gain +1d to Consort when you gather information on a target for a score. You get +1d to the engagement roll for that operation." },
            { tier: 4, name: "Mentat Cerebrum Implant", description: "Due to your careful planning, during downtime, you may give yourself or another crew member +1 downtime action." },
            { tier: 5, name: "Programmed Receptors", description: "When you indulge your vice, you may adjust the dice outcome by 1 or 2 (up or down). An ally who joins in your vice may do the same." }
        ]
    },
